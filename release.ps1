...
$appName = "AzureKeyvaultExplorer" # 👈 Replace with your application project name.
$projDir = "AzureKeyvaultExplorer" # 👈 Replace with your project directory (where .csproj resides).
